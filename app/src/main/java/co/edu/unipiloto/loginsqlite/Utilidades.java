...
public class Utilidades {
    ...
    public final static String CAMPO_SPINNER="spinner";
    public final static String CAMPO_SEXO="sexo";

    public static final String CREAR_TABLA_USUARIO = "CREATE TABLE " + TABLA_USUARIO + "("+CAMPO_NOMBRECOMPLETO+" TEXT, "+CAMPO_USUARIOREGISTRADO+" TEXT, "+CAMPO_FECHA+" TEXT,"
            +CAMPO_CORREO+" TEXT, "+CAMPO_CONTRASENA+" TEXT, "+CAMPO_CONFIRMARCONTRASENA+" TEXT, "+CAMPO_SPINNER+" TEXT , " +CAMPO_SEXO+" TEXT) ";
